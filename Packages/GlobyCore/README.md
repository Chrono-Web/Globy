...
- Stato: core Swift verificabile senza UI; non è il progetto dell'app
...
- SSE è un hint: senza conferma HTTP non nasce una VOX e non parte una notifica.
...
- Aggiornamento di una VOX già letta ≠ nuova pubblicazione.
- Ritiro solo con 404 sul dettaglio; una VOX uscita dal solo RSS resta disponibile.
