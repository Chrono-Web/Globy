...
| ADR | Stato | Decisione |
|---|---|---|
| [0001](0001-globy-e-una-utility-macos-con-mascotte-facoltativa.md) | proposto | Globy è una utility macOS con mascotte facoltativa |
| [0002](0002-http-e-autorevole-sse-e-un-segnale.md) | proposto | HTTP è autorevole e SSE è un segnale |
